...
const serverEnvSchema = z.object({
  ...
  GITHUB_MODELS_API_KEY: z.string().min(1, "GITHUB_MODELS_API_KEY must not be empty").optional(),
  GITHUB_MODELS_BASE_URL: z.string().url("GITHUB_MODELS_BASE_URL must be a valid URL").default("https://models.inference.ai.azure.com"),
...
export function parseServerEnv(env: EnvSource): ServerEnv {
  return serverEnvSchema.parse({
    ...
    GITHUB_MODELS_API_KEY: env.GITHUB_MODELS_API_KEY,
    GITHUB_MODELS_BASE_URL: env.GITHUB_MODELS_BASE_URL,
